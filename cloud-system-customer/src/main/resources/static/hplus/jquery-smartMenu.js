  ...
  $.fn.smartMenu = function (data, options) {
    ...
    var htmlCreateMenu = function (datum) {
      var dataMenu = datum || data,
          ...
          htmlMenu = "", htmlCorner = "", clKey = "smart_menu_";
      if ($.isArray(dataMenu) && dataMenu.length) {
        htmlMenu = '<div id="smartMenu_' + nameMenu + '" class="' + clKey
            + 'box">' +
        ...
        $.each(dataMenu, function (i, arr) {
          if (i) {
            htmlMenu = htmlMenu + '<li class="' + clKey
                + 'li_separate">&nbsp;</li>';
          }
          if ($.isArray(arr)) {
      ...
      var idKey = "#smartMenu_", clKey = "smart_menu_",
      ...
      if (!jqueryMenu.size()) {
        ...
        $(idKey + params.name + " li").each(function () {
          ...
          $(this).hover(function () {
            ...
            jqueryHover.removeClass(clHover).children("." + clKey
                + "box").hide();
            jqueryHover.children("." + clKey + "a").removeClass(clKey
                + "a_hover");
